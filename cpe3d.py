...
class Object3D(Object):
    def __init__(self, vao, nb_triangle, program, texture, transformation, hasHitbox, hitbox):
...
class Camera:
    def __init__(self, transformation = Transformation3D(translation=pyrr.Vector3([1, 1, 0], dtype='float32')), projection = pyrr.matrix44.create_perspective_projection(60, 1, 0.01, 100)):
        self.transformation = transformation
